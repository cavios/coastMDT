...
\newpage
# Preface
The software package coastMDT was developed as part of the deliverable D4 in the ESA STSE project "GOCE++ Dynamic Topography at the coast and tide gauge unification (DYCOT)". More information regarding the projects are found in the project deliverables D1-D12 which are (or will be) from the project web page http://gocehsu.eu/.     
